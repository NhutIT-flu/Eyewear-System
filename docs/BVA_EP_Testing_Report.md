...
**Mục tiêu:** Kiểm thử biên giá trị của `base_price` khi tạo/cập nhật sản phẩm.
**Miền hợp lệ:** `0 <= base_price <= 100,000,000`.

| Test ID | Input | Điều kiện BVA | Kết quả mong đợi |
| :--- | :--- | :--- | :--- |
| BVA-CAT-01 | `base_price = -1` | Dưới biên dưới | Exception: "Invalid price boundaries." |
| BVA-CAT-02 | `base_price = 0` | Tại biên dưới | Hợp lệ, xử lý thành công. |
| BVA-CAT-03 | `base_price = 100000000` | Tại biên trên | Hợp lệ, xử lý thành công. |
| BVA-CAT-04 | `base_price = 100000001` | Trên biên trên | Exception: "Invalid price boundaries." |
